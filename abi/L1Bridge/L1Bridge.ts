...
export interface L1BridgeInterface extends utils.Interface {
  functions: {
    "availableVaults(address)": FunctionFragment;
    "bridgeHandles(uint16)": FunctionFragment;
    ...
    "setBridgeHandle(uint16,address)": FunctionFragment;
    ...
    "transferERC20FromValut(uint16,address,uint256,address)": FunctionFragment;
    "transferETH(uint16,uint256,address)": FunctionFragment;
    "transferETHFromVault(uint16,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "setVault"
      | "transferERC20"
      | "transferERC20FromValut"
      | "transferETH"
      | "transferETHFromVault"
      | "transferOwnership"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "availableVaults",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "bridgeHandles",
  ...
  encodeFunctionData(
    functionFragment: "transferERC20FromValut",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "transferETHFromVault",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NewBridgeHandle(uint16,address)": EventFragment;
    "NewFees(uint16,uint256)": EventFragment;
    "NewNonceContract(address)": EventFragment;
    "NewVault(address,bool)": EventFragment;
...
export type NewVaultEvent = TypedEvent<[string, boolean], NewVaultEventObject>;
...
export interface L1Bridge extends BaseContract {
  ...
  functions: {
    ...
    setBridgeHandle(
      chainId_: PromiseOrValue<BigNumberish>,
      handler_: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setVault(
      ...
      isAvailable_: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    transferERC20(
      dstChainId_: PromiseOrValue<BigNumberish>,
      l1Token_: PromiseOrValue<string>,
  ...
  filters: {
    ...
    "NewBridgeHandle(uint16,address)"(
      chainId?: null,
      BridgeHandle?: null
    ): NewBridgeHandleEventFilter;
    NewBridgeHandle(
      chainId?: null,
      BridgeHandle?: null
    ): NewBridgeHandleEventFilter;
    ...
    "NewVault(address,bool)"(
      vault?: null,
      availabled?: null
    ): NewVaultEventFilter;
    NewVault(vault?: null, availabled?: null): NewVaultEventFilter;
